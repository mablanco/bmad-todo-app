...
- **Input document:** Strategic context and stakeholder narrative live in **`project-brief.md`** (same planning folder); this PRD is the authoritative requirements set for implementation.
